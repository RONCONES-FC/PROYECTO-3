...
public class PaginaProfesorMaestro extends JFrame {
    public PaginaProfesorMaestro() {
        setTitle("Página de Profesor Maestro");
        setSize(400, 300);
        ...
        JLabel lblTitulo = new JLabel("Bienvenido, Profesor Maestro");
